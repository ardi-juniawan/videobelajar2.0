        ...
        <>
            <div className="content">
                ...
                <div className="card-frame1">
                    ...
                    <div className="card-wrapper">
                        ...
                        <p>
                            ...
                            Senior Accountant di <span className="text-tebal">Gojek</span>
                            </span>
                        </p>
                        </div>
                        ...
                        <div className="price">
                            <span className="text-tebal">Rp 300K</span>
                        </div>
                        </div>
                    </div>
                    </div>
                ...
                <div className="title-banner">
                    ...
                    <span className="title title-banner-cta">
                    Mau Belajar Lebih Banyak?
                    </span>
                    <span className="caption caption-banner-cta">
                    Daftarkan dirimu untuk mendapatkan informasi terbaru dan penawaran
                    spesial dari program-program terbaik hariesok.id
                    </span>
                </div>
                <div className="form-banner-cta">
